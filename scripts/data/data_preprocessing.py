...
true_images = list_pictures(path_to_raw_data + "data_true/")
list_true_images = [img_to_array(load_img(x, grayscale=True)) for x in true_images]
false_images = list_pictures(path_to_raw_data + "data_false/")
list_false_images = [img_to_array(load_img(x, grayscale=True)) for x in false_images]


def save_photos(list_true_images):
	for i in range(len(list_true_images)):
		x = array_to_img(list_true_images[i]).save('res/aug_' + str(i) + '.jpg')
